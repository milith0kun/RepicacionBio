...
process proteinQCESM1v {
  ...
  python3 ${moduleDir}/bin/esm1v.py \
    ${pdb_dir} \
	"${batch_dir}/esm_1v.csv" \
	--chains "${chains}" \
...
workflow {
  proteinQCESM1v([params.output_dir, params.pdb_dir], params.chains, params.esm_models_path)
}
